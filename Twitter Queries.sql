...
INSERT INTO `order` (`order_date`, `pprice`, `order_quantity`, `ucid`, `pid`, `mid`, `uid`) 
...
VALUES (100, 9999, 2000, 12/05/2021, `Good project but long project`);

INSERT INTO `tweets` (`tcount`, `tid`, `uid`, `tdate`, `content`) 
VALUES (300, 9009, 4000, 12/05/2021, `Good project but long project`);
